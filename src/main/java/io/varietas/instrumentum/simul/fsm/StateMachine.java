 ...
 * <h2>StateMachine</h2>
 *
 * This interface has to be implemented by each finite state machine.
 *
...
public interface StateMachine {
    ...
    void fire(final Enum transition, final StatedObject target) throws TransitionInvocationException, InvalidTransitionError;
}
