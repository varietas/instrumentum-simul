...
import io.varietas.instrumentum.simul.fsm.AbstractChainStateMachine;
...
public class ChainStateMachineWithListener extends AbstractChainStateMachine {

    public ChainStateMachineWithListener(FSMConfigurationImpl configuration) {
        super(configuration);
    }

    @TransitionListener(SimpleListener.class)
