 ...
 */
package io.varietas.instrumentum.simul.fsm.machines.chain;
 ...
 */
@Slf4j
@ChainListener(SimpleChainListener.class)
...
public class ChainStateMachineWithChainListener extends AbstractChainStateMachine {
